...
public class GuiManager {
    public static HashMap<String, buttonClass> guiDataMap = new HashMap<>();
    ...
    public static void initGuiData(){
        ...
        for(int i=2;i>=0;i--){
            if(i == 2){
                ...
                guiDataMap.put("fengli6",new buttonClass(0,needList,3,giveList,
                ...
                guiDataMap.put("xiaolv6",new buttonClass(0,needList,10,3,giveList,
                ...
                guiDataMap.put("naijiu4",new buttonClass(0,needList,giveList,
